...
int uavData_publish::doProxy()
{
    ...
    while(ros::ok())
    {
		...
		uavdata_d.vo_x = m_puavData->mFeedback_data.vo_x;
		uavdata_d.vo_y = m_puavData->mFeedback_data.vo_y;
		uavdata_d.vo_z = m_puavData->mFeedback_data.vo_z;
		uavdata_d.vo_health = m_puavData->mFeedback_data.vo_health;
